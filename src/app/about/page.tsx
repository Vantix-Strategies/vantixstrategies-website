...
export default function AboutPage() {
  return (
    <div className="pt-14">
      ...
      {/* Minneapolis context */}
      <section className="py-24 bg-[#09090b] border-b border-zinc-800">
      ...
      {/* Contact section */}
      <section id="contact" className="py-20 bg-[#18181b] border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            <span className="text-xs tracking-[0.2em] uppercase text-zinc-600">Contact</span>
            <h2
              className="text-4xl md:text-5xl text-white mt-3 mb-4 max-w-2xl"
              style={{ fontWeight: 300, letterSpacing: "0.05em" }}
            >
