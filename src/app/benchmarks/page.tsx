...
const generalAssumptions = [
  {
    ...
    explanation:
      "When you select a band (e.g., \u201c$25M\u2013$100M\u201d), the model uses the arithmetic midpoint ($62.5M). This is a deliberate choice to produce unbiased estimates without anchoring to either extreme. If your organization sits at the high end of a band, your actual savings will likely exceed the estimate.",
  },
  {
...
const capabilityBenchmarks = [
  {
    ...
    assumptions: [
      ...
      },
      {
        ...
        explanation:
          "Organizations that deploy AI-assisted decision support consistently report 1\u20132% revenue impact from faster cycle times, better lead scoring, dynamic pricing, and reduced churn. We model 1.5% as a conservative midpoint. This uplift is independent of labor savings and compounds with scale.",
      ...
      {
        label: "Conservative\u2013Optimistic range multiplier: \u00d70.85 \u2013 \u00d71.35",
        explanation:
    ...
    assumptions: [
      {
        ...
        explanation:
          "IDC\u2019s Data and Analytics research consistently finds that knowledge workers spend 30\u201340% of their time searching for, cleaning, or waiting on data. We apply a conservative floor of 3.5 hours per week per employee \u2014 below the IDC mean \u2014 to represent the portion attributable specifically to brittle reporting workflows, not general research time.",
      ...
      },
      {
        ...
        source: "Forrester TEI methodology; Snowflake customer outcome studies (2022\u20132024)",
      },
      {
      ...
      {
        label: "Conservative\u2013Optimistic range multiplier: \u00d70.80 \u2013 \u00d71.40",
        explanation:
  ...
  },
  {
    ...
    assumptions: [
      ...
      },
      {
        ...
        explanation:
          "McKinsey\u2019s Operations Practice benchmarks consistently show 15\u201325% efficiency improvements in the first 12 months of systematic process redesign engagements. We model 20% as the midpoint. This applies to the ops-dependent revenue base (30% of total), not total revenue, keeping the estimate grounded.",
        source: "McKinsey Operations Practice, \u201cLean Management in the Digital Age\u201d (2023); Bain, \u201cOperational Integration Playbook\u201d",
      },
      {
        label: "Conservative\u2013Optimistic range multiplier: \u00d70.85 \u2013 \u00d71.50",
        explanation:
